...
@dso_cache = dso_local local_unnamed_addr global [742 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 152218401, ; hash 0x912ab21, from name: aot-MyFirstMauiApp
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1004948558, ; hash 0x3be64c4e, from name: MyFirstMauiApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MyFirstMauiApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 163
	...
	%struct.DSOCacheEntry {
		i64 1119329669, ; hash 0x42b79d85, from name: aot-MyFirstMauiApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MyFirstMauiApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 181
	...
	%struct.DSOCacheEntry {
		i64 1405036643, ; hash 0x53bf2863, from name: libaot-MyFirstMauiApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MyFirstMauiApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 234
	...
	%struct.DSOCacheEntry {
		i64 3241523704, ; hash 0xc135b9f8, from name: MyFirstMauiApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MyFirstMauiApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 577
	...
	%struct.DSOCacheEntry {
		i64 3532400844, ; hash 0xd28c28cc, from name: libaot-MyFirstMauiApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MyFirstMauiApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 621
...
@assembly_store_bundled_assemblies = dso_local local_unnamed_addr global [153 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 4
